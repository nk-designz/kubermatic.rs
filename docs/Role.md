...
**namespace** | Option<**String**> | Indicates the scope of this role. | [optional]
**rules** | Option<[**Vec<crate::models::PolicyRule>**](PolicyRule.md)> | Rules holds all the PolicyRules for this Role | [optional]
