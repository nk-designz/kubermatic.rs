...
pub struct ExternalClusterMachineDeployment {
    ...
    pub cloud: Option<Box<crate::models::ExternalClusterMachineDeploymentCloudSpec>>,
    ...
    pub phase: Option<Box<crate::models::ExternalClusterMdPhase>>,
    #[serde(rename = "spec", skip_serializing_if = "Option::is_none")]
    pub spec: Option<Box<crate::models::NodeDeploymentSpec>>,
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<Box<crate::models::MachineDeploymentStatus>>,
}

impl ExternalClusterMachineDeployment {
    /// ExternalClusterMachineDeployment represents an object holding external cluster machine deployment
    pub fn new() -> ExternalClusterMachineDeployment {
