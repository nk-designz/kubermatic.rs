...
pub struct ApplicationInstallation {
    ...
    pub spec: Option<Box<crate::models::ApplicationInstallationSpec>>,
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<Box<crate::models::ApplicationInstallationStatus>>,
}

impl ApplicationInstallation {
    pub fn new() -> ApplicationInstallation {
